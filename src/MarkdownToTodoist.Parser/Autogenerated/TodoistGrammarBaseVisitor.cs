...
/// <summary>
/// This class provides an empty implementation of <see cref="ITodoistGrammarVisitor{Result}"/>,
...
public partial class TodoistGrammarBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, ITodoistGrammarVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitTask([NotNull] TodoistGrammarParser.TaskContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitSubtask([NotNull] TodoistGrammarParser.SubtaskContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitCheckbox([NotNull] TodoistGrammarParser.CheckboxContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitDescription([NotNull] TodoistGrammarParser.DescriptionContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitInline([NotNull] TodoistGrammarParser.InlineContext context) { return VisitChildren(context); }
}
